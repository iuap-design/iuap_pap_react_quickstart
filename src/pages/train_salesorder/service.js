...
//定义接口地址
const URL = {
    "GET_DETAIL":  `${GROBAL_HTTP_CTX}/train_salesorder/getAssoVo`,
    "SAVE_ORDER":  `${GROBAL_HTTP_CTX}/train_salesorder/saveAssoVo`,
    "GET_LIST":  `${GROBAL_HTTP_CTX}/train_salesorder/list`,
    "DEL_ORDER":  `${GROBAL_HTTP_CTX}/train_salesorder/deleteBatch`,
}
...
export const saveTrainSalesorder = (params) => {
    return request(URL.SAVE_ORDER, {
        method: "post",
        data: params
    });
}
export const delTrainSalesorder = (params) => {
